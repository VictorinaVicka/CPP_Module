...
/*   Updated: 2020/12/05 12:44:00 by tfarenga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (form.getSigned() != 0)
		std::cout << *this << " Cannot sign " << form << " because the form to be signed." << std::endl;
	else if (newGrade > form.getSignGrade())
	{
		std::cout << *this << " Cannot sign " << form << " because its too low." << std::endl;
	}
	else
	{
